...
if 'x070' in os.environ["RWKV_MY_TESTING"]:
    from .rwkvx import RUN_RWKV7_STATE,RUN_CUDA_RWKV7g
...
# if 'x070' in os.environ["RWKV_MY_TESTING"] and 'cuda' in os.environ["RWKV_MY_ARCHITECTURE"]:
#     CHUNK_LEN = 16
...
# elif 'x070' in os.environ["RWKV_MY_TESTING"]:
#     print('x070 Wind Triton Mode')
