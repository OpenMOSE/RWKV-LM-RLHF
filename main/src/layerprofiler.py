...
v7_additional_parameters = ['router','nm_','x_r','x_w','x_k','x_v','x_a','x_g','att.w1','att.w2','att.w0','att.a1','att.a2','att.a0','att.v1','att.v2','att.v0','att.g1','att.g2','att.k_k','att.k_a','att.r_k']
