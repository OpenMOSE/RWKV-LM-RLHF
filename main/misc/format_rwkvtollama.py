...
def convert_text_format(original_text: str) -> str:
    ...
    for part in parts:
        ...
        # {content}
        # <|im_end|>
        segment_str = f"<|start_header_id|>{role}<|end_header_id|>{content}<|eot_id|>"
...
def main():
    input_dir = "myfolder/2024_dataset/General3"
    output_dir = "myfolder/2024_dataset/General3_llama"
        ...
        if filename.endswith(".jsonl"):
            ...
            with open(input_path, "r", encoding="utf-8") as fin, \
                ...
                for line in fin:
                    ...
                    if "text" in data:
                        # 変換を行う
                        data["text"] = '<|begin_of_text|>' + convert_text_format(data["text"]) + '<|end_of_text|>'
