...
parser.add_argument("--input_folder", default="example.csv", type=str)
parser.add_argument("--output_folder", default="rlhfoutput.csv", type=str)
...
def process_csv_file(input_file, output_file):
    with open(input_file, 'r', encoding='utf-8') as csv_file, \
        ...
        for row in csv_reader:
            ...
            conversation.append(f"User: {processed_prompt}{endtoken}Assistant: {processed_chosen}{endtoken}")
