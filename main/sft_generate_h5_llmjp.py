...
parser.add_argument("--input_folder", default="myfolder/2024_dataset/General3_llama", type=str)
parser.add_argument("--output_parquet", default="myfolder/2024_dataset/General3_llama_llmjp.h5", type=str)
#\x17
...
tokenizer = AutoTokenizer.from_pretrained(os.path.dirname(os.path.abspath(__file__)) + "/tokenizer/llmjp")
