...
DPO_pair_number = 5000 # from 2 to 61965
...
model = RWKV("RWKV-5-World-3B-v2-20231113-ctx4096.pth", "cuda bf16")
...
RawData = []
NowRawPosition = 0
with open("example.csv", "r",encoding='utf-8-sig', newline='') as file:
...
#add general DPO dataset for anti overfitting
import pandas as pd
